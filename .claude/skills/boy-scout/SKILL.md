...
> **Note (this repo):** imported from
> [ertugrul-dmr/clean-code-skills](https://github.com/ertugrul-dmr/clean-code-skills)
> (MIT — see `../skills/clean-code-skills-LICENSE`), unmodified below this note.
> Where a rule here conflicts with this repo's own `CLAUDE.md` (e.g. "default to
> no comments," the ~200-line/2+-usage extraction guideline instead of a fixed
> line/argument count, minimalism over proactive abstraction), `CLAUDE.md` wins.
