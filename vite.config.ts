...
// build (see .github/workflows/ci.yml's preview-build job) publishes under
// its own subpath ("/routines/pr-<n>/") so it can live alongside main's
// deployment on the same GitHub Pages site instead of overwriting it.
